...
export function HeroPhoneSection() {
    const { addToCart } = useCartStore();
      ...
      const handleClick = () => {
        addToCart({id: "899", model: "iphone 16 pro max", brand: "Apple", colorId:"Desert Titanium", capacity: "256", price: "1199", quantity: 1, imageUrl: "images/phone-section/phone1.jpg"});
      }
    return (
